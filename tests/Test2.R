...
PM10 = read.table("tests/EjemploLMCMexico2/PartMat10.txt",head=T,dec=",")
coord = read.table("tests/EjemploLMCMexico2/Coords_DAMABog.txt",dec=",",sep="\t",header=T,row.names=1)
...
PM10=read.table("tests/EjemploLMCMexico2/PM10.txt",head=T,dec=".")
RAMA_Coordenadas=read.table("tests/EjemploLMCMexico2/RAMA_PM10_coordenadas.txt",head=T,row.names=1,dec=",")
...
NO2=read.table("tests/EjemploLMCMexico2/NO2.txt",head=T,dec=".")
estacionesNO2=read.table("tests/EjemploLMCMexico2/estacionesNO2.txt",head=T,dec=".")
nrow(estacionesNO2)

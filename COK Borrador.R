...
# Semivariograma
gst = gstat(NULL,"PM10_1", X1~1, data = puntaj_PM10)
gst = gstat(gst,"PM10_2", X2~1, data = puntaj_PM10 )
gst = gstat(gst,"NO2_1", X1~1, data = puntaj_NO2)
gst = gstat(gst,"NO2_2", X2~1, data = puntaj_NO2)
